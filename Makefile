...
all: ./Examples/medialEx.vo\
  ...
  ./Kernel/struct_ex.vo\
  ./Kernel/semLex.vo\
  ./Kernel/apply_rule_props.vo\
  ./Kernel/struct_props.vo\
  ./Kernel/natDedGram.vo\
  ./Kernel/sequent.vo\
  ./Kernel/lambda_reduction.vo\
  ./Kernel/final_sem.vo\
  ./Kernel/lambda_bruijn.vo\
  ./Kernel/notations.vo\
  ./Kernel/basics.vo\
  ./Kernel/natDed.vo\
  ./Kernel/interp_coq.vo\
  ./Kernel/derivSem.vo\
  ./Kernel/lambda_coq.vo\
  ./Kernel/logic_const.vo\
  ./Meta/unaries.vo\
  ./Meta/medialExtraction.vo\
  ./Meta/seqNatDed.vo\
  ./Meta/unbounDep.vo\
  ./Meta/crossDep.vo\
  ./Meta/polarity.vo\
  ./Meta/derivedRulesNatDed.vo
